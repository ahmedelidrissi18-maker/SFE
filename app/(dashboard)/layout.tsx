...
export default async function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background lg:[--dashboard-sidebar-width:280px]">
      <div className="pointer-events-none fixed inset-x-0 top-[-5rem] -z-10 h-[22rem] bg-[radial-gradient(circle_at_top_left,_rgba(36,56,156,0.07),_transparent_62%)]" />
      <div className="pointer-events-none fixed bottom-[-10rem] right-[-8rem] -z-10 h-[20rem] w-[20rem] rounded-full bg-[rgba(255,183,132,0.06)] blur-3xl" />
      <div className="lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:w-[var(--dashboard-sidebar-width)] lg:p-4">
        <AppSidebar role={session.user.role} />
      </div>
      <div className="min-w-0 px-3 py-3 sm:px-4 sm:py-4 lg:ml-[var(--dashboard-sidebar-width)] lg:p-4">
